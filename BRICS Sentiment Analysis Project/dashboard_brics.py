...
option = st.sidebar.radio('Pilih Visualisasi : ', ['Barchart', 'Wordcloud', 'Trigrams', 'Top Words'])
...
# Visualisasi Top Words Sentimen
    ...
    sentimen_option = st.siderbar.selectbox('Pilih Sentimen: ', ['Positif', 'Negatif', 'Netral'])
